    ...
    <section class="features">
      <div class="container">
        ...
        <div class="section-title">
          ...
          <p>RPPL is the first LPG company in India to come up with Cylinder Accounting & Tracking Software(CATS). Safety Audit, Safety Maintenance and Safety training to be priority. With CATS software , we can track each and every cylinder movement with which maximum problems are solved. Poor People will having options to buy Cylinders.</p>
        </div>
        ...
        <div class="row" data-aos="fade-up">
          ...
          <div class="col-md-7 pt-5 order-2 order-md-1">
            ...
            <p class="fst-italic">RPPL will have solutions like.</p>
            <ul>
