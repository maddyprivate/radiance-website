        ...
        <div class="row">
          <div class="col-md-6 col-lg-3 d-flex align-items-stretch" data-aos="fade-up">
            <div class="icon-box icon-box-pink">
              ...
              <h4 class="title"><a href="">WE ARE</a></h4>
              <p class="description">LPG Provider who Always looking to become a better version of ourselves and never settle for anything less than that.</p>
            </div>
          </div>
          ...
          <div class="col-md-6 col-lg-3 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="100">
            <div class="icon-box icon-box-cyan">
              ...
              <h4 class="title"><a href="">Our Straigth</a></h4>
              <p class="description">Our Directors and staff are highly experienced in LPG Industry and follow every norms laid by Petroleum Explosive Safety Organization(PESO)</p>
            </div>
          </div>
          ...
          <div class="col-md-6 col-lg-3 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="200">
            <div class="icon-box icon-box-green">
              ...
              <p class="description">Being LPG provider we treating customers with respect and building their faith on us and constantly Growing through the feedback and motivation given by the customers.</p>
            </div>
          </div>
          ...
          <div class="col-md-6 col-lg-3 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="200">
            <div class="icon-box icon-box-blue">
              ...
              <p class="description">To become a consistent and stable brand in the LPG sector and set up a corporate team that has a vision of expanding the business and establishing it as the best brand in PAN India.</p>
            </div>
          </div>
    ...
    <section class="pricing section-bg" data-aos="fade-up">
      <div class="container">
        ...
        <div class="section-title">
          <h2>Pricing</h2>
          <p>You can find the affordable price for all our products which can fullfil your need.</p>
        </div>
        ...
        <div class="row no-gutters">
          ...
          <div class="col-lg-4 box">
            ...
            <ul>
              <li><i class="bx bx-check"></i> Best LPG quality</li>
              <li><i class="bx bx-check"></i> Accurate Weight</li>
              <li><i class="bx bx-check"></i> Delivery on Time</li>
              <li><i class="bx bx-check"></i> <span>99.99 % Safery</span></li>
              <li><i class="bx bx-check"></i> <span>Including service charges</span></li>
            </ul>
